	...
	public function render(): string
	{
		...
		<section class="pwt-section" id="pwt-booking">
			<header class="pwt-section-header">
				<h2><?php esc_html_e('Book Your Wild Tour', 'panna-wild-tour'); ?></h2>
				<p><?php esc_html_e('Share your travel date and preferences. We will confirm availability and pricing.', 'panna-wild-tour'); ?></p>
			</header>
			...
			<form class="pwt-booking-form" method="post">
				...
				<div class="pwt-form-grid">
					<label>
						<span><?php esc_html_e('Full Name *', 'panna-wild-tour'); ?></span>
						<input type="text" name="name" required>
					</label>

					<label>
						<span><?php esc_html_e('Phone *', 'panna-wild-tour'); ?></span>
						<input type="text" name="phone" required>
					</label>

					<label>
						<span><?php esc_html_e('Email', 'panna-wild-tour'); ?></span>
						<input type="email" name="email">
					</label>

					<label>
						<span><?php esc_html_e('Travel Date *', 'panna-wild-tour'); ?></span>
						<input type="date" name="travel_date" min="<?php echo esc_attr(current_time('Y-m-d')); ?>" required>
					</label>

					<label>
						<span><?php esc_html_e('Number of Persons *', 'panna-wild-tour'); ?></span>
						<input type="number" name="persons" min="1" max="30" required>
					</label>

					<label>
						<span><?php esc_html_e('Preferred Package', 'panna-wild-tour'); ?></span>
					...
					<label class="pwt-full-width">
						<span><?php esc_html_e('Message', 'panna-wild-tour'); ?></span>
						<textarea name="message" rows="4" placeholder="<?php esc_attr_e('Tell us your travel goals, stay type, and any special requests.', 'panna-wild-tour'); ?>"></textarea>
					</label>
				</div>

				<button type="submit" class="pwt-btn"><?php esc_html_e('Send Booking Request', 'panna-wild-tour'); ?></button>
